#ifndef __TWO_VERTEX_CONNECTED_
#define __TWO_VERTEX_CONNECTED_
#include "lib.hpp"
#include "graph.hpp"
#include <tuple>
...
class TwoVertexConnected {
    ...
    public:
        explicit TwoVertexConnected(graph::Graph graph) : given_(graph), num_count_(0) {}
