#ifndef __TWO_VERTEX_CONNECTED_SQUARE_
#define __TWO_VERTEX_CONNECTED_SQUARE_
#include "lib.hpp"
#include "graph.hpp"
#include <tuple>

class TwoVertexConnectedSquare {
    public:
        graph::Graph given_;
        integer num_count_;
    private:
    ...
    public:
        explicit TwoVertexConnectedSquare(graph::Graph graph) : given_(graph), num_count_(0) {}
